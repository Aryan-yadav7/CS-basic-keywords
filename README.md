...
A.6 TPU: TPU stands for Tensor processing unit. A TPU is a custom made application-specific integrated circuit (ASIC) developed by google to speed up machine learning workload. TPUs are designed for neural networks and are known for their high 
